        ...
        "products": [
            {
                ...
                "active": True,
                "articles": [
                    {"name": "Unité", "price": 2.50, "active": True},
                    {"name": "Lot de 2", "price": 4.50, "active": True},
                ],
            },
            {
                "name": "Kiwi",
                "active": True,
                "articles": [
                    {"name": "Unité", "price": 0.75, "active": True},
                    {"name": "Lot de 5", "price": 3.00, "active": True},
                ],
            },
            {
                "name": "Ananas",
                "active": False,
                "articles": [{"name": "Unité", "price": 2.50, "active": False}],
            },
        ],
    },
    {
        ...
        "products": [
            {
                ...
                "active": True,
                "articles": [
                    {"name": "Unité", "price": 1.00, "active": True},
                    {"name": "Lot de 3", "price": 2.50, "active": False},
                ],
            }
        ],
    },
        ...
        "products": [
            {
                ...
                "active": True,
                "articles": [
                    {"name": "100g", "price": 1.00, "active": False},
                    {"name": "300g", "price": 2.50, "active": False},
                ],
            }
        ],
    },
